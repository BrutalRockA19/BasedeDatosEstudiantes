...
class ListEdit : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if( studentsDb.studentsGetAllString().size >0){
            ...
            ltvMisEstudiantesEdit.adapter=miAdaptador

            ltvMisEstudiantesEdit.setOnItemClickListener { adapterView: AdapterView<*>, view1: View, position: Int, id: Long ->
    ...
    override fun onResume() {
        super.onResume()
        Log.d("UDELP","Hola estoy en onResume")
